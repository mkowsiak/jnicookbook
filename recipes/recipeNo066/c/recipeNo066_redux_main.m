...
int main(int argc, const char * argv[]) {
  @autoreleasepool {
    ...
    NSString *classPathFromApp = [[NSBundle mainBundle] resourcePath];
    options[0].optionString = (char *)[[NSString stringWithFormat: @"-Djava.class.path=%@/target", classPathFromApp] UTF8String];
    ...
    jclass cls_Main = (*env)->FindClass (env, "recipeNo066/redux/Main");
