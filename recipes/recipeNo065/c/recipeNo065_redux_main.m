...
int main(int argc, const char * argv[]) {
  @autoreleasepool {
    ...
    options[0].optionString = (char *)[[NSString stringWithFormat: @"-Djava.class.path=%@/workspace/jnicookbook/recipes/recipeNo065/target", home] UTF8String];
    ...
    jclass cls_Main = (*env)->FindClass (env, "recipeNo065/redux/Main");
