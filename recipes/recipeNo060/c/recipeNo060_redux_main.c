...
int main() {
  ...
  options[0].optionString 
    = "-Djava.class.path=./target:../target:./conf:./jar/log4j-core.jar:./jar/log4j-api.jar";
 
  // if you want to see how log4j is initialized, you can
  // always pass -Dlog4j.debug
  //options[1].optionString = "-Dlog4j.debug";
  ...
  jclass cls_Main = (*env)->FindClass (env, "recipeNo060/redux/Main");
