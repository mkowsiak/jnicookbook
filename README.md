...
_JNI Cookbook_ samples were adapted to `Java 14` release. You shouldn't experience any issues while working with most recent release of `Java`. If you have stuck with `Java 8` - for any reasons - you should be able to use samples as well.
...
|---|---|
|[recipe&nbsp;№&nbsp;001](http://jnicookbook.owsiak.org/)|running simple JNI code [[source]](https://github.com/mkowsiak/jnicookbook/tree/master/recipes/recipeNo001)|
